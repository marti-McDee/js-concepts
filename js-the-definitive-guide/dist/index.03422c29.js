...
})(
  {
    '6kwI0': [
      function (require, module, exports) {
        ...
        module.bundle.HMR_BUNDLE_ID = '3355c9eb03422c29'
...
${frame.code}`
    ...
    kKp6Z: [
      function (require, module, exports) {
        /***  Chapter 13: Asynchronous JavaScript  ***/ // Using asynchronous JavaScript (such as callbacks, promises, and async/await), you can perform long network requests
        // without blocking the main thread.
        /** 13.1 Asynchronous Programming with Callbacks **/ /* Timers */ // display name in the console after 4 seconds
        setTimeout(
          firstName => {
        ...
        // third
        // second
        /* Events */ let okay = document.getElementById('confirm')
        const p = document.getElementById('my-paragraph')
        okay.addEventListener('pointerdown', function () {
          console.log(this.innerHTML)
        })
        /* Network Events */ const request = new XMLHttpRequest()
        // send GET request to test API
        const getText = function (callback) {
          var request = new XMLHttpRequest()
          request.onreadystatechange = function () {
            if (request.readyState == 4 && request.status == 200) callback(request.responseText) // Another callback here
          }
        ...
        inner.addEventListener('pointerover', _ => getText(cb)) /* Callbacks and Events in Node */
      },
      {}
    ]
  },
...
//# sourceMappingURL=index.03422c29.js.map
