...
"use strict";
/* Function Declarations */ // print the name and value of each property of o. Return undefined
...
// Foo()
/* Function Expressions */ const square = function(x) {
    return x * x;
};
...
/* Arrow Functions */ const sum = (x, y)=>x + y;
...
/* Arrow functions do not have a prototype property, which means that they cannot be used as constructor functions for
 new classes */ /* Nested Functions */ function highOnPotenuse(a, b) {
    function square(x) {
        return x * x;
    }
...
//# sourceMappingURL=functions.2e33aae2.js.map
